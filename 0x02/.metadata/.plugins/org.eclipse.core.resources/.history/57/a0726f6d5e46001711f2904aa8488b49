...
public class Task1 extends Applet {
    ...
    void generateKeyPair(APDU apdu){
    	...
    	for(short i = 0; i<pubSize ; i+=4){
    		pubMod[i] = 			pubExp[i] =				(byte)0xFE;
    		pubMod[(short)(i+1)] = 	pubExp[(short)(i+1)] =	(byte)0xED;
    		pubMod[(short)(i+2)] =	pubExp[(short)(i+2)] =	(byte)0xFA;
    		pubMod[(short)(i+3)] =	pubExp[(short)(i+3)] =	(byte)0xCE;
    	}
